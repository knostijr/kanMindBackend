...
class Board(models.Model):
    ...
    title = models.CharField(max_length=200, help_text="Board-Titel")
...
class Task(models.Model):
    ...
    title = models.CharField(max_length=200, help_text="Task-Titel")
    description = models.TextField(blank=True, help_text="Task-Beschreibung")
    status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, default="to-do", help_text="Task-Status"
    )
